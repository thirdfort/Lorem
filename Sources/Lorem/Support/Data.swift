...
extension Lorem where Content == String {
    public enum Data { }
}

public extension Lorem.Data where Content == String {

    /// The source `words` used to generate composed Lorem Ipsum
    ...
    /// The source `firstNames` used to generate composed Lorem Ipsum
    ...
    /// The source `lastNames` used to generate composed Lorem Ipsum
    ...
    /// The source `siteDomains` used to generate composed Lorem Ipsum
    static let siteDomains: [String] = {
        "twitter.com google.com youtube.com wordpress.org adobe.com blogspot.com godaddy.com wikipedia.org wordpress.com yahoo.com linkedin.com amazon.com flickr.com w3.org apple.com myspace.com tumblr.com digg.com microsoft.com vimeo.com pinterest.com qq.com stumbleupon.com youtu.be addthis.com miibeian.gov.cn delicious.com baidu.com feedburner.com bit.ly facebook.com meta.com"
            .components(separatedBy: " ")
    }()

    /// The source `emailDomains` used to generate composed Lorem Ipsum
    static let emailDomains: [String] = {
        "gmail.com yahoo.com hotmail.com email.com live.com me.com mac.com aol.com fastmail.com mail.com"
            .components(separatedBy: " ")
    }()

    /// The source `tweets` used to generate composed Lorem Ipsum
    static let tweets: [String] = {
        [
